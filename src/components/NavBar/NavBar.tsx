    ...
    <div className={styles.wrapper}>
      <div className={styles.list}>
        <a
          ...
          className={
            topicString === 'WEDDING' ? styles.item_clicked : styles.item
          }
        >
          WEDDINGS
        </a>
        <a
          ...
          className={
            topicString === 'NATURE' ? styles.item_clicked : styles.item
          }
        >
          NATURE
        </a>
        <a
          ...
          className={
            topicString === 'ANIMAL' ? styles.item_clicked : styles.item
          }
        >
          ANIMALS
        </a>
